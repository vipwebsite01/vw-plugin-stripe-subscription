<?php
/**
 * Plugin Name: VW Plugin Stripe Subscription
...
register_deactivation_hook( __FILE__, 'vw_plugin_stripe_subscription_deactivate' );
function vw_plugin_stripe_subscription_deactivate() {
    // Itt végezheted el a plugin deaktiválási műveleteit
}

// Beállítjuk a plugin működését
add_action( 'init', ['\VwPluginStripeSubscription\Plugin', 'init'] );
